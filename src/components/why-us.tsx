  ...
  return (
    <section ref={ref} className="bg-gray-900 flex justify-center w-full pt-20 pb-20">
      <div className="mx-auto md:px-28">
        ...
        {/* List container: vertical stacking for all devices */}
        <div className="cards flex flex-col space-y-4 text-white">
          {[
            {
              icon: <ComputerIcon />,
              title: "One Interface",
            ...
            <motion.div
              ...
              className="w-full p-4 transform hover:scale-105 transition-all duration-300"
            >
              <div className="bg-gray-800 w-full p-6 rounded-md hover:shadow-lg">
