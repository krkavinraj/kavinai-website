        ...
        <section className='flex justify-center py-20 px-4'>
            <div className="waitlist max-w-4xl space-y-8 text-center">
                <div className="icon flex justify-center animate-pulse">
                    <GiftIcon className='size-32 text-rose-600 dark:text-rose-400 bg-gradient-to-br from-pink-100 to-blue-100 dark:from-pink-900/30 dark:to-blue-900/30 p-6 rounded-[2rem] shadow-lg' />
                </div>
